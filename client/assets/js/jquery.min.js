...
!(function (a, b) {
  ...
  let c = [], d = a.document, e = Object.getPrototypeOf, f = c.slice, g = c.concat, h = c.push, i = c.indexOf, j = {}, k = j.toString, l = j.hasOwnProperty, m = l.toString, n = m.call(Object), o = {}; function p(a, b) { b = b || d; const c = b.createElement('script'); c.text = a, b.head.appendChild(c).parentNode.removeChild(c); } var q = '3.2.1', r = function (a, b) { return new r.fn.init(a, b); }, s = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, t = /^-ms-/, u = /-([a-z])/g, v = function (a, b) { return b.toUpperCase(); }; r.fn = r.prototype = {
  ...
  }); let F, G = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, H = r.fn.init = function (a, b, c) { let e, f; if (!a) return this; if (c = c || F, typeof a === 'string') { if (e = a[0] === '<' && a[a.length - 1] === '>' && a.length >= 3 ? [null, a, null] : G.exec(a), !e || !e[1] && b) return !b || b.jquery ? (b || c).find(a) : this.constructor(b).find(a); if (e[1]) { if (b = b instanceof r ? b[0] : b, r.merge(this, r.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : d, !0)), C.test(e[1]) && r.isPlainObject(b)) for (e in b)r.isFunction(this[e]) ? this[e](b[e]) : this.attr(e, b[e]); return this; } return f = d.getElementById(e[2]), f && (this[0] = f, this.length = 1), this; } return a.nodeType ? (this[0] = a, this.length = 1, this) : r.isFunction(a) ? void 0 !== c.ready ? c.ready(a) : a(r) : r.makeArray(a, this); }; H.prototype = r.fn, F = r(d); let I = /^(?:parents|prev(?:Until|All))/, J = {
    children: !0, contents: !0, next: !0, prev: !0
  }; r.fn.extend({
    has(a) { let b = r(a, this), c = b.length; return this.filter(function () { for (let a = 0; a < c; a++) if (r.contains(this, b[a])) return !0; }); }, closest(a, b) { let c, d = 0, e = this.length, f = [], g = typeof a !== 'string' && r(a); if (!A.test(a)) for (;d < e; d++) for (c = this[d]; c && c !== b; c = c.parentNode) if (c.nodeType < 11 && (g ? g.index(c) > -1 : c.nodeType === 1 && r.find.matchesSelector(c, a))) { f.push(c); break; } return this.pushStack(f.length > 1 ? r.uniqueSort(f) : f); }, index(a) { return a ? typeof a === 'string' ? i.call(r(a), this[0]) : i.call(this, a.jquery ? a[0] : a) : this[0] && this[0].parentNode ? this.first().prevAll().length : -1; }, add(a, b) { return this.pushStack(r.uniqueSort(r.merge(this.get(), r(a, b)))); }, addBack(a) { return this.add(a == null ? this.prevObject : this.prevObject.filter(a)); }
    ...
    a = typeof a === 'string' ? M(a) : r.extend({}, a); var b, c, d, e, f = [], g = [], h = -1, i = function () { for (e = e || a.once, d = b = !0; g.length; h = -1) { c = g.shift(); while (++h < f.length)f[h].apply(c[0], c[1]) === !1 && a.stopOnFalse && (h = f.length, c = !1); }a.memory || (c = !1), b = !1, e && (f = c ? [] : ''); }, j = {
    ...
    Deferred(b) {
      var c = [['notify', 'progress', r.Callbacks('memory'), r.Callbacks('memory'), 2], ['resolve', 'done', r.Callbacks('once memory'), r.Callbacks('once memory'), 0, 'resolved'], ['reject', 'fail', r.Callbacks('once memory'), r.Callbacks('once memory'), 1, 'rejected']], d = 'pending', e = {
        ...
        }, f = {}; return r.each(c, (a, b) => { let g = b[2], h = b[5]; e[b[1]] = g.add, h && g.add(() => { d = h; }, c[3 - a][2].disable, c[0][2].lock), g.add(b[3].fire), f[b[0]] = function () { return f[`${b[0]}With`](this === f ? void 0 : this, arguments), this; }, f[`${b[0]}With`] = g.fireWith; }), e.promise(f), b && b.call(f, f), f;
    },
    when(a) { let b = arguments.length, c = b, d = Array(c), e = f.call(arguments), g = r.Deferred(), h = function (a) { return function (c) { d[a] = this, e[a] = arguments.length > 1 ? f.call(arguments) : c, --b || g.resolveWith(d, e); }; }; if (b <= 1 && (P(a, g.done(h(c)).resolve, g.reject, !b), g.state() === 'pending' || r.isFunction(e[c] && e[c].then))) return g.then(); while (c--)P(e[c], h(c), g.reject); return g.promise(); }
  ...
  }; let W = new V(), X = new V(), Y = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Z = /[A-Z]/g; function $(a) { return a === 'true' || a !== 'false' && (a === 'null' ? null : a === `${+a}` ? +a : Y.test(a) ? JSON.parse(a) : a); } function _(a, b, c) { let d; if (void 0 === c && a.nodeType === 1) if (d = `data-${b.replace(Z, '-$&').toLowerCase()}`, c = a.getAttribute(d), typeof c === 'string') { try { c = $(c); } catch (e) {}X.set(a, b, c); } else c = void 0; return c; }r.extend({
  ...
  }, (a, b) => { r.fn[a] = function (a) { for (var c, d = [], e = r(a), f = e.length - 1, g = 0; g <= f; g++)c = g === f ? this : this.clone(!0), r(e[g])[b](c), h.apply(d, c.get()); return this.pushStack(d); }; }); let La = /^margin/, Ma = new RegExp(`^(${aa})(?!px)[a-z%]+$`, 'i'), Na = function (b) { let c = b.ownerDocument.defaultView; return c && c.opener || (c = a), c.getComputedStyle(b); }; !(function () {
  ...
  }()); function Oa(a, b, c) { let d, e, f, g, h = a.style; return c = c || Na(a), c && (g = c.getPropertyValue(b) || c[b], g !== '' || r.contains(a.ownerDocument, a) || (g = r.style(a, b)), !o.pixelMarginRight() && Ma.test(g) && La.test(b) && (d = h.width, e = h.minWidth, f = h.maxWidth, h.minWidth = h.maxWidth = h.width = g, g = c.width, h.width = d, h.minWidth = e, h.maxWidth = f)), void 0 !== g ? `${g}` : g; } function Pa(a, b) { return { get() { return a() ? void delete this.get : (this.get = b).apply(this, arguments); } }; } let Qa = /^(none|table(?!-c[ea]).+)/, Ra = /^--/, Sa = { position: 'absolute', visibility: 'hidden', display: 'block' }, Ta = { letterSpacing: '0', fontWeight: '400' }, Ua = ['Webkit', 'Moz', 'ms'], Va = d.createElement('div').style; function Wa(a) { if (a in Va) return a; let b = a[0].toUpperCase() + a.slice(1), c = Ua.length; while (c--) if (a = Ua[c] + b, a in Va) return a; } function Xa(a) { let b = r.cssProps[a]; return b || (b = r.cssProps[a] = Wa(a) || a), b; } function Ya(a, b, c) { const d = ba.exec(b); return d ? Math.max(0, d[2] - (c || 0)) + (d[3] || 'px') : b; } function Za(a, b, c, d, e) { let f, g = 0; for (f = c === (d ? 'border' : 'content') ? 4 : b === 'width' ? 1 : 0; f < 4; f += 2)c === 'margin' && (g += r.css(a, c + ca[f], !0, e)), d ? (c === 'content' && (g -= r.css(a, `padding${ca[f]}`, !0, e)), c !== 'margin' && (g -= r.css(a, `border${ca[f]}Width`, !0, e))) : (g += r.css(a, `padding${ca[f]}`, !0, e), c !== 'padding' && (g += r.css(a, `border${ca[f]}Width`, !0, e))); return g; } function $a(a, b, c) { let d, e = Na(a), f = Oa(a, b, e), g = r.css(a, 'boxSizing', !1, e) === 'border-box'; return Ma.test(f) ? f : (d = g && (o.boxSizingReliable() || f === a.style[b]), f === 'auto' && (f = a[`offset${b[0].toUpperCase()}${b.slice(1)}`]), f = parseFloat(f) || 0, `${f + Za(a, b, c || (g ? 'border' : 'content'), d, e)}px`); }r.extend({
    ...
    animate(a, b, c, d) { let e = r.isEmptyObject(a), f = r.speed(b, c, d), g = function () { const b = kb(this, r.extend({}, a), f); (e || W.get(this, 'finish')) && b.stop(!0); }; return g.finish = g, e || f.queue === !1 ? this.each(g) : this.queue(f.queue, g); },
    stop(a, b, c) { const d = function (a) { const b = a.stop; delete a.stop, b(c); }; return typeof a !== 'string' && (c = b, b = a, a = void 0), b && a !== !1 && this.queue(a || 'fx', []), this.each(function () { let b = !0, e = a != null && `${a}queueHooks`, f = r.timers, g = W.get(this); if (e)g[e] && g[e].stop && d(g[e]); else for (e in g)g[e] && g[e].stop && db.test(e) && d(g[e]); for (e = f.length; e--;)f[e].elem !== this || a != null && f[e].queue !== a || (f[e].anim.stop(c), b = !1, f.splice(e, 1)); !b && c || r.dequeue(this, a); }); },
    finish(a) { return a !== !1 && (a = a || 'fx'), this.each(function () { let b, c = W.get(this), d = c[`${a}queue`], e = c[`${a}queueHooks`], f = r.timers, g = d ? d.length : 0; for (c.finish = !0, r.queue(this, a, []), e && e.stop && e.stop.call(this, !0), b = f.length; b--;)f[b].elem === this && f[b].queue === a && (f[b].anim.stop(!0), f.splice(b, 1)); for (b = 0; b < g; b++)d[b] && d[b].finish && d[b].finish.call(this); delete c.finish; }); }
    ...
    ajaxTransport: Mb(Jb),
    ajax(b, c) {
      typeof b === 'object' && (c = b, b = void 0), c = c || {}; var e, f, g, h, i, j, k, l, m, n, o = r.ajaxSetup({}, c), p = o.context || o, q = o.context && (p.nodeType || p.jquery) ? r(p) : r.event, s = r.Deferred(), t = r.Callbacks('once memory'), u = o.statusCode || {}, v = {}, w = {}, x = 'canceled', y = {
  ...
  }), r.holdReady = function (a) { a ? r.readyWait++ : r.ready(!0); }, r.isArray = Array.isArray, r.parseJSON = JSON.parse, r.nodeName = B, typeof define === 'function' && define.amd && define('jquery', [], () => { return r; }); let Vb = a.jQuery, Wb = a.$; return r.noConflict = function (b) { return a.$ === r && (a.$ = Wb), b && a.jQuery === r && (a.jQuery = Vb), r; }, b || (a.jQuery = a.$ = r), r;
}));
